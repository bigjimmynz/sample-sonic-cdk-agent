# AWS Whats New Demo Setup Guide

This guide will help you set up and deploy the Amazon Nova Sonic Call Center Agent demo specifically configured for the AWS Whats New blog posts.

## Overview

The aws demo includes:
- AWS Whats New rss search feed functionality
- Ability to email further blog details
...
When prompted, select "aws" as your industry-specific demo. 
...
4. Try queries like:
   - "Tell me what's new at AWS"
   - "Tell me more about XX"
   - "Send me details about XX entry"
